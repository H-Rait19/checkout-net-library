namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _itemsApiUri;
        private static string _itemApiUri;
        private static string _allItemsApiUri;
        ...
        public static string ShoppingListItems
            => _cardsApiUri ?? (_itemsApiUri = string.Concat(AppSettings.BaseApiUri, "/ShoppingList/?itemName={0}&quantity={1}"));

        public static string ShoppingListItem
            => _cardsApiUri ?? (_itemApiUri = string.Concat(AppSettings.BaseApiUri, "/ShoppingList/?itemName={0}"));

        public static string ShoppingListAllItems
            => _cardsApiUri ?? (_allItemsApiUri = string.Concat(AppSettings.BaseApiUri, "/ShoppingList/"));
    }
}